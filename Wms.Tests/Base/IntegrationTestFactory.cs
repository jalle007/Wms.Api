...
public class IntegrationTestFactory<TApiMarker> : WebApplicationFactory<TApiMarker>, IAsyncLifetime where TApiMarker : class
{
    ...
    //{
    //    yield return typeof(Wms.Tests.Program).Assembly;
    //}
    ...
    public async Task ClearDbTable<TDbContext>(string tableName, string schemaName = "public") where TDbContext : DbContext
    {
